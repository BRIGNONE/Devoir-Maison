 ...
 * @author jobri
 */
public class DevoirMaisonBrignone {
   ...
   //==========================================================================================================================================================================================================================
    ...
    { //DEBUT DES 3 ESSAIES
        ...
        {                                                       
            ...
            {                                                               
            System.out.println(NEWLINE+"ECHEC !!! Vous avez fais 7 tetatives, le coffre est bloquer !");
            System.exit(0);
            }
        ...
        System.out.println(NEWLINE+"FELICITATION !!! Vous avez deverouiller le coffre et partez sans etre arreter !");
        System.exit(0);
    ...
    { //DEBUT DES 3 ESSAIES
        ...
        while (valeurMoyen != nbAleaMoyen)
        {
            ...
            if (nbEssaie == 10)
            {
            System.out.println(NEWLINE+"ECHEC !!! Vous avez fais 10 tetatives, le coffre est bloquer !");
            System.exit(0);
            }
    ...
    while (difficile <= 3){ //DEBUT DES 3 ESSAIES
        ...
        while (valeurDiffici1e != nbAleaDiffici1e)
        {
            ...
            if (nbEssaie == 20)
            {
            System.out.println(NEWLINE+"ECHEC !!! Vous avez fais 20 tetatives, le coffre est bloquer !");
            System.exit(0);
            }
...
class MyTask extends TimerTask{
    ...
    public void run() {
        ...
        if (times != 0) {                                          // Si le temps est different de 0 alors ...
            System.out.println("                        " + times +" secondes avant que les gendarmes arrive");  //Affiche le temps sur le coté
        } else {
            System.out.println("Les gendarmes sont arrivées et vous arrête, vous avez perdu !");  
